...
let AuthController = class AuthController {
    ...
    async updateUser(response, userId, updateAuthDto) {
        try {
            const existingUser = await this.authService.updateUser(userId, updateAuthDto);
            return response.status(common_1.HttpStatus.OK).json({ message: 'User has been successfully updated', existingUser, });
        }
        catch (err) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, dto_1.UpdateAuthDto]),
...
__decorate([
    (0, common_1.Put)('/cambiarPassword'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_b = typeof common_1.Request !== "undefined" && common_1.Request) === "function" ? _b : Object]),
